...
test('linting custom styles (1)', () => {
  ...
  expect(diagnostics).toHaveProperty('0.message', "Global variable '$baz' does not exist.")
...
test('linting custom styles (2)', () => {
  ...
  expect(diagnostics).toHaveProperty('0.message', "Global variable '$bar' does not exist.")
  expect(diagnostics).toHaveProperty('1.from', 42)
  expect(diagnostics).toHaveProperty('1.to', 46)
  expect(diagnostics).toHaveProperty('1.message', "Global variable '$baz' does not exist.")
})
