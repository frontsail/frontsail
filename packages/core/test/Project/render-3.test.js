...
test('rendering', () => {
  ...
  expect(results.html).toBe(
    '<!DOCTYPE html><html lang="en"><head><meta charset="UTF-8"><meta http-equiv="X-UA-Compatible" content="IE=edge"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>Test</title></head><body><div>&lt;&amp;foo&gt;</div><div x-data=""><span x-bind="bar" bar="&amp;bar">&amp;bar</span></div></body></html>',
  )
})
